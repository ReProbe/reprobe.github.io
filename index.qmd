    ...
    <div class="checkpoint-row">
      ...
      <div class="checkpoint-pills">
        <a href="https://huggingface.co/JingweiNi/ReProbe_Qwen3-8B_self_anno" class="checkpoint-pill" target="_blank">
          <img src="https://huggingface.co/front/assets/huggingface_logo-noborder.svg" class="hf-logo" alt="HF"> Qwen3-8B · self-anno
        </a>
        <a href="https://huggingface.co/JingweiNi/ReProbe_Qwen3-8B_DeepSeek_anno" class="checkpoint-pill" target="_blank">
          <img src="https://huggingface.co/front/assets/huggingface_logo-noborder.svg" class="hf-logo" alt="HF"> Qwen3-8B · DeepSeek-anno
        </a>
        <a href="https://huggingface.co/JingweiNi/ReProbe_Qwen3-1.7B_natural_reasoning_GPT-OSS-120B_anno" class="checkpoint-pill" target="_blank">
          <img src="https://huggingface.co/front/assets/huggingface_logo-noborder.svg" class="hf-logo" alt="HF"> Qwen3-1.7B · thinking
        </a>
        <a href="https://huggingface.co/JingweiNi/ReProbe_Qwen3-32B_GPT-OSS-120B_anno" class="checkpoint-pill" target="_blank">
          <img src="https://huggingface.co/front/assets/huggingface_logo-noborder.svg" class="hf-logo" alt="HF"> Qwen3-32B · thinking
        </a>
      </div>
    </div>
...
<section class="method-section">
  <div class="container">
    ...
    <div class="method-overview" style="margin-top:48px; max-width:78%; margin-left:auto; margin-right:auto;">
